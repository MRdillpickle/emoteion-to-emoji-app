...
console.info('ml5 veriton: ' + ml5.version);
classifier = ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/1z9hNxoIA/model.json', modelLoaded);
function modelLoaded() {console.info("model loaded!");}
function speak() {
    var synth = window.speechSynthesis;
    speak_data_1 = "the first prdiction is " + prediction_1;
    speak_data_2 = "and the othor on is" + prediction_2;
